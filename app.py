...
team = User(full_name = "Marketing Team ", email = "team@marketing.co", password = "adminpass")
db.session.add(team)

# Create all pets
 = Pet(name = "Nelly", age = "5 weeks", bio = "I am a tiny kitten rescued by the good people at Paws Rescue Center. I love squeaky toys and cuddles.")
